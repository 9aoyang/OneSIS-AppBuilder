...
declare const _default: import('vue').DefineComponent<
  ...
  },
  {
      ...
      | ({
          ...
          $props: Partial<{
            ...
            Omit<
              ...
              'config' | 'values' | 'fullscreen' | 'confirmText'
            >;
          $attrs: {
            [x: string]: unknown;
          };
              ...
              form: import('vue').Ref<
                | ({
                    ...
                    $parent:
                      ...
                      | null;
                    $emit: (
                      event: 'change' | 'field-input' | 'field-change',
                      ...args: any[]
                    ) => void;
                    $el: any;
                    $options: import('vue').ComponentOptionsBase<
                      ...
                      import('vue').ComponentOptionsMixin,
                      ('change' | 'field-input' | 'field-change')[],
                      string,
                      {
                        config: import('../schema').FormConfig;
                        initValues: Record<string, any>;
    ...
    disable: import('vue').ComputedRef<
      | boolean
      | ((
