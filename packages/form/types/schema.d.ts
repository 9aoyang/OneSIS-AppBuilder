...
export declare type TypeFunction = (
  mForm: FormState | undefined,
  data: {
...
declare type SelectOptionFunction = (
  mForm: FormState | undefined,
  data: {
    model: any;
    prop?: string;
...
declare type RemoteSelectOptionBodyFunction = (
  mForm: FormState | undefined,
  data: {
    model: any;
    formValue: any;
...
declare type RemoteSelectOptionRequestFunction = (
  mForm: FormState | undefined,
  res: any,
  data: {
    model: any;
...
export declare type ChildConfig =
  | FormItem
  | TabConfig
  | RowConfig
  | FieldsetConfig
